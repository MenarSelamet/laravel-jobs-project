                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="h-8 w-8" src="logo-M.jpg" alt="Your Company">
                        </div>
            ...
            <div class="hidden md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        <div class="flex-shrink-0">
                            <img class="h-10 w-10 rounded-full" src="logo-M.jpg" alt="">
                        </div>
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white">Angry Llama</div>
                            <div class="text-sm font-medium leading-none text-gray-400">lamawithdrama@lama.com</div>
                        </div>
                    </div>
                    <div class="mt-3 space-y-1 px-2">
                        ...
                        <form method="POST" action="/logout">
                            @csrf
                            <button type="submit"
                                class="block w-full text-left rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Log
                                Out</button>
                        </form>
                        @endauth
                    </div>
